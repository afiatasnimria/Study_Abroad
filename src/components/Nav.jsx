    ...
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
        ...
        <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <button className="pill-btn outline-btn" style={{ fontSize: 13 }} onClick={() => onNavigate('login')}>Login</button>
          <button className="pill-btn primary-btn" style={{ fontSize: 13 }} onClick={() => onNavigate('register')}>Register</button>
        </div>
